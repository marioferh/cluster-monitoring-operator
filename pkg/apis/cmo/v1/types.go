...
const (
	...
	CMOName    = "clustermonitoringoperators"
	CMOKindKey = "clustermonitoringoperator"
)

// NOTE: json tags are required.  Any new fields you add must have json tags for the fields to be serialized.

// ClusterMonitoringOperatorSpec defines the desired state of ClusterMonitoringOperator
type ClusterMonitoringOperatorSpec struct {
...
type ClusterMonitoringOperatorStatus struct {
...
type ClusterMonitoringOperator struct {
...
type ClusterMonitoringOperatorList struct {
	metav1.TypeMeta `json:",inline"`
